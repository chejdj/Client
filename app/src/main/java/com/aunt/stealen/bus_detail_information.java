...
import com.aunt.view.timelineadpater;
...
/**
 * Created by 洋洋 on 2017/5/5.
 */
public class bus_detail_information  extends Activity {
    private ListView list;
    private Button back_bus_information;
    private TextView icon_bus;
    private timelineadpater adapter;
    private MyApplication1 tracp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list=(ListView)findViewById(R.id.bus_detail_list);
        list.setDividerHeight(0);
        tracp=(MyApplication1)getApplicationContext();
        back_bus_information=(Button)findViewById(R.id.back_bus_information);
        icon_bus=(TextView)findViewById(R.id.bus_number);
        refre=(RefreshableView)findViewById(R.id.refresh);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(bus_detail_information.this,MainActivity.class);
    ...
    class backlistener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            Intent intent = new Intent(bus_detail_information.this,information_bus.class);
            startActivity(intent);
        }
    }
