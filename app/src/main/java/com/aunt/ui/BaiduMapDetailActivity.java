...
import com.aunt.R;
import com.aunt.util.SenseorManager;
...
public class BaiduMapDetailActivity extends Activity {
    ...
    class backlistener implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            Intent intent = new Intent(BaiduMapDetailActivity.this, BusDetailActivity.class);
    ...
    private void initGPS() {
        ...
        if (!locationManager
            ...
            Toast.makeText(BaiduMapDetailActivity.this, "请打开GPS",
            ...
            dialog.setNeutralButton("取消", new android.content.DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    arg0.dismiss();
                    Toast.makeText(BaiduMapDetailActivity.this, "可能导致位置有偏差", Toast.LENGTH_SHORT).show();
                }
            });
            dialog.show();
        }
