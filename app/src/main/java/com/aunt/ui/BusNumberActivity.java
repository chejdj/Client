...
import com.aunt.widget.listchangeadapter;
...
public class BusNumberActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackap = (AuntApplication) getApplication();
    ...
    final Handler hander = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                Intent intent = new Intent(BusNumberActivity.this, BusDetailActivity.class);
    ...
    class mylistener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(BusNumberActivity.this, MainActivity.class);
            startActivity(intent);
        }
    }
