...
import com.aunt.util.distanceUtil;
import com.aunt.util.GsonUtil;
import com.aunt.bean.HistoryTrackData;
...
public class AuntApplication extends Application {
    ...
    {
        distance=new distanceUtil(latLngList,this.direct);
        distance.calucate();
    ...
    public void queryhistory(String temp){
        ...
        HistoryTrackData historyTrackData = GsonUtil.parseJson(history_track,
